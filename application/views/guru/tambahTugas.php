            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="row">
                        ...
                        <form action="<?= base_url('Tugas/prosesUploadTugas')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" readonly value="<?= $kodeKelas[0]->NamaKelas?>" name="kodeKelas" placeholder="kodeKelas" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" readonly value="<?= $kodeMapel[0]->NamaMapel?>" name="kodeMapel" placeholder="kodeMapel" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="datetime-local" id="text-input" name="deadline" placeholder="Deadline" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
