                                     ...
                                     ?>
                                        <tr>
                                            ...
                                            <?php if ($a->KodeGuru == $guru->KodeGuru) { ?>
                                                <td>
                                                    <a href="<?=base_url()?>guru/buatAbsen/<?=$a->KodeKelas?>/<?= $a->KodeMapel?>" class="btn btn-primary">Buat Absensi</a>
                                                    <br><br>
                                                    <a href="<?=base_url()?>guru/historyAbsen/<?=$a->KodeKelas?>/<?= $a->KodeMapel?>" class="btn btn-success">Cek Absensi</a>
                                                </td>
                                            <?php }else{?>
                                                <td></td>
                                            <?php }?>
