                                        ...
                                        <tbody>
                                            <?php foreach ($absen as $a) { ?>
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td class="desc"><?= $a->jam_mulai ?></td>
                                                    <td class="desc"><?= $a->jam_selesai ?></td>
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <a href="<?= base_url('absen/absensi/'). $a->id_absen?>"class="item" data-toggle="tooltip" data-placement="top" title="Detail">
