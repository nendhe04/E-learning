          ...
          <tr>
            ...
            <td>
              <div class="table-data-feature">
                <a href="<?= base_url('siswa/materi/detailMateri/').$key->id_materi?>"class="item" data-toggle="tooltip" data-placement="top" title="Detail">
                  <i class="btn btn-success">Detail"></i>
                </a>
              </div>
            </td>
          </tr>
