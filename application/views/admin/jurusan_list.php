...
<div class="container-fluid">
  ...
  <div align="left">
    <a href="<?php echo base_url('index.php/admin/jurusan/tambah/'); ?>" class="btn btn-success">Tambah</a>
  </div>
  <br>
<?php } ?>
      ...
      <table class="table table-hover" id="myTable">
        ...
        <tbody id="isi_jurusan">
          <?php $no=1; foreach ($jurusanList as $key) { ?>
            <tr>
              <td><?php echo $no; ?></td>
              ...
              <td><?php echo $key->jurusan; ?></td>
                ...
                <?php if ($this->session->userdata('level') == '1') { ?>
              <td>
                <a href="<?php echo base_url('index.php/admin/jurusan/edit/');echo $key->id_jurusan; ?>" class="btn btn-warning">Edit</a> <a onclick="return confirm('Apakah yakin ingin hapus?')" href="<?php echo base_url('index.php/admin/jurusan/hapus/');echo $key->id_jurusan; ?>" class="btn btn-danger">Hapus</a>
