...
<div class="container-fluid">
  ...
  <input type="text" class="form-control" id="KodeMapel" name="KodeMapel" placeholder="Kode Mapel" required>
  </div>
  <div class="form-group">
  ...
  <label>Jurusan<font color="red">*</font></label>
      <select name="id_jurusan" class="form-control" >
        <?php foreach ($jurusanList as $key) { ?>
          <option value ="<?php echo $key->id_jurusan ?>"><?php echo $key->jurusan ?></option>
        <?php } ?>
      </select>
    </div>
