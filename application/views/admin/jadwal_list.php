...
<div class="container-fluid">
  ...
  <div align="left">
    <a href="<?php echo base_url('index.php/admin/jadwal/tambah/'); ?>" class="btn btn-success">Tambah</a>
  </div>
  <br>
<?php } ?>
      ...
      <table class="table table-hover" id="myTable">
        ...
        <tbody id="isi_jadwal">
          <?php $no=1; foreach ($jadwalList as $key) { ?>
            <tr>
              <td><?php echo $no; ?></td>
              ...
              <td><?php echo $key->NamaKelas; ?></td>
                ...
                <?php if ($this->session->userdata('level') == '1') { ?>
              <td>
                <a href="<?php echo base_url('index.php/admin/jadwal/edit/');echo $key->id_jadwal; ?>" class="btn btn-warning">Edit</a> <a onclick="return confirm('Apakah yakin ingin hapus?')" href="<?php echo base_url('index.php/admin/jadwal/hapus/');echo $key->id_jadwal; ?>" class="btn btn-danger">Hapus</a>            
              </td>
              <?php } ?>
            </tr>
          <?php $no++; } ?>
