...
<div class="form-group">
  <label>ID Mapel Kelas<font color="red">*</font></label>
  <input type="text" class="form-control" id="id_mapel_kelas" name="id_mapel_kelas" value="<?php echo $mapelKelas[0]->id_mapel_kelas ?>">
  </div>
  <div class="form-group">
    <label>Kode Mapel<font color="red">*</font></label><br>
  ...
  <div class="form-group">
    <label>Kode Guru<font color="red">*</font></label><br>
