...
<div class="container-fluid">
  ...
  <?php 
  echo form_open('index.php/admin/jadwal/tambah/'); 
  echo validation_errors();
  ?>

  <div class="form-group">
  <label>ID Jadwal<font color="red">*</font></label>
  <input type="text" class="form-control" id="id_jadwal" name="id_jadwal" placeholder="Isikan ID Jadwal" required>
  </div>
  <div class="form-group">
  ...
  <input type="text" class="form-control" id="hari" name="hari" placeholder="Isikan Nama Hari" required>
  </div>
  <div class="form-group">
    <label>Jam<font color="red">*</font></label>
    <input type="time" class="form-control" id="jam" name="jam" placeholder="Isikan Jam" required>
  </div>
  <div class="form-group">
