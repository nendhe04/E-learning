...
<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <input type="text" class="form-control" id="KodeGuru" name="KodeGuru" placeholder="Isikan Kode Guru" value="<?php echo $guru[0]->KodeGuru ?>" name="KodeGuru" required>
    </div>
    <div class="form-group">
    <label>Nama Guru<font color="red">*</font></label>
    <input type="text" class="form-control" id="NamaGuru" name="NamaGuru" placeholder="Isikan Nama Guru" value="<?php echo $guru[0]->NamaGuru ?>" name="NamaGuru" required>
    </div>
    <div class="form-group">
   ...
   <div class="form-group">
      ...
      <select name="JenisKelamin" class="form-control">
        <option value="P" <?php if ($guru[0]->JenisKelamin == 'P') { ?> selected <?php } ?>>Peremuan</option>
        <option value="L" <?php if ($guru[0]->JenisKelamin == 'L') { ?> selected <?php } ?>>Laki Laki</option>
      </select>
    </div>
    <div class="form-group">
